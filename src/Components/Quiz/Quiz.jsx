...
const Quiz = () => {
  ...
  const nextQuestion = () => {
    ...
    document.getElementById("app").style.backgroundImage =
      "url('" + questions[currQuestion].img + "')";
    ...
    if (questions[currQuestion].answer == optionChosen) {
      ...
      document.getElementById(
        "btn-" + questions[currQuestion].answer
      ).style.color = "#008c23";
      document.getElementById(
        "btn-" + questions[currQuestion].answer
      ...
      document.getElementById("btn-" + optionChosen).style.borderColor =
        "#FF5B52";
      document.getElementById(
        "btn-" + questions[currQuestion].answer
      ).style.color = "#51C22A";
      ...
      <div className="terminal-wrapper">
        <div className="terminal-top ">
          <div className="top-left">
            <div id="red" className="red circle "></div>
            <div id="yellow" className="yellow circle"></div>
            {/* Hint for one of the questions */}
            <a
              id="green"
              href="https://preview.redd.it/0zw17rx7z1541.jpg?auto=webp&s=31eac5c8e060c596ba0fdd3944857a7145b6894c"
          ...
          <div className="top-mid">
            ...
            <span className="">
              root@fsociety:~/Mr_Robot/Quiz/Question_{questionCounter}
            </span>
          </div>
          {/* Show timer in top-right */}
          <div
            className="top-right"
            style={{ color: counter < 11 && "#FF5B52" }}
          >
            {counter}
          </div>
        </div>
        <div id="terminal-wrapper" className="terminal-bot">
          ...
          <p className="terminal-prompt last-login">
            ...
            your time is:{" "}
            <span style={{ color: counter < 11 && "#FF5B52" }}>{counter}</span>
          </p>
          {/* Hint */}
          <p className="terminal-prompt mt-25 terminal-msg">
            <span className="terminal-green">
              {d.getHours()}:{minutes} {"<"}mr. robot{">"}
            </span>{" "}
            {questions[currQuestion].hint}{" "}
          </p>
          {/* Question */}
          <p className="mt-25 terminal-prompt">
            <span className="terminal-green">
              root@fsociety:~/Mr_Robot/Quiz/Question_{questionCounter}
              {">"}
            </span>{" "}
          ...
          <div className="mt-10 terminal-prompt terminal-text terminal-start">
            <p className="terminal-green">
              root@fsociety:~/Mr_Robot/Quiz/Question_{questionCounter}/Option_A
              {">"}
            </p>
            <button
              id="btn-a"
              ...
              className="optionBtn option-transition"
            >
          ...
          <div className="mt-10 terminal-prompt terminal-text terminal-start">
            <p className="terminal-green">
              root@fsociety:~/Mr_Robot/Quiz/Question_{questionCounter}/Option_B
              {">"}
            </p>
            <button
              id="btn-b"
          ...
          <div className="mt-10 terminal-prompt terminal-text terminal-start">
            <p className="terminal-green">
              root@fsociety:~/Mr_Robot/Quiz/Question_{questionCounter}/Option_C
              {">"}
            </p>
            <button
              id="btn-c"
          ...
          <div className="mt-10 terminal-prompt terminal-text terminal-start">
            <p className="terminal-green">
              root@fsociety:~/Mr_Robot/Quiz/Question_{questionCounter}/Option_D
              {">"}
            </p>
            <button
              id="btn-d"
          ...
          <div className="mt-10 terminal-prompt terminal-text terminal-start">
            <p className="terminal-green">
              root@fsociety:~/Mr_Robot/Quiz/{lastQuestion}
              {">"}
            </p>
            ...
            <button
              ...
              className="startBtn button-transition"
            >
              {" "}
              {questionCounter < 10 ? "Next question" : "End quiz"}
            </button>
          </div>
          {/* Give up button */}
          <div
          ...
          >
            <p className="terminal-green">
              root@fsociety:~/Mr_Robot/Quiz/Give_Up{">"}
            </p>
            <button
              id="giveUpBtn"
              onClick={() => {
          ...
          <div className="fadeIn delay-0_5 mt-10 terminal-prompt terminal-text terminal-start terminal-giveUp">
            <p className="terminal-green">
              root@fsociety:~/Mr_Robot/Quiz/Give_Up/Yes{">"}
            </p>
            <button
              onClick={() => {
                restartQuiz();
          ...
          <div className="fadeIn delay-0_7 mt-10 terminal-prompt terminal-text terminal-start terminal-giveUp">
            <p className="terminal-green">
              root@fsociety:~/Mr_Robot/Quiz/Give_Up/No{">"}
            </p>
            <button
              onClick={() => {
                cancel();
              }}
              className="startBtn giveUp-transition"
            >
              No
            </button>
          </div>
          ...
          <div className="queens">
            <p>
              Hello friend. You finnaly found me -{">"}{" "}
